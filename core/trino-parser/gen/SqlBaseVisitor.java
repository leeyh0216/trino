...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#catalogProperties}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCatalogProperties(SqlBaseParser.CatalogPropertiesContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#catalogPropertyAssignments}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCatalogPropertyAssignments(SqlBaseParser.CatalogPropertyAssignmentsContext ctx);
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#catalogProperty}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCatalogProperty(SqlBaseParser.CatalogPropertyContext ctx);
	/**
