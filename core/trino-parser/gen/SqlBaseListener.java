...
public interface SqlBaseListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterCreateCatalog(SqlBaseParser.CreateCatalogContext ctx);
	/**
	 * Exit a parse tree produced by the {@code createCatalog}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitCreateCatalog(SqlBaseParser.CreateCatalogContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#catalogProperties}.
	 * @param ctx the parse tree
	 */
	void enterCatalogProperties(SqlBaseParser.CatalogPropertiesContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#catalogProperties}.
	 * @param ctx the parse tree
	 */
	void exitCatalogProperties(SqlBaseParser.CatalogPropertiesContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#catalogPropertyAssignments}.
	 * @param ctx the parse tree
	 */
	void enterCatalogPropertyAssignments(SqlBaseParser.CatalogPropertyAssignmentsContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#catalogPropertyAssignments}.
	 * @param ctx the parse tree
	 */
	void exitCatalogPropertyAssignments(SqlBaseParser.CatalogPropertyAssignmentsContext ctx);
	/**
	 * Enter a parse tree produced by {@link SqlBaseParser#catalogProperty}.
	 * @param ctx the parse tree
	 */
	void enterCatalogProperty(SqlBaseParser.CatalogPropertyContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlBaseParser#catalogProperty}.
	 * @param ctx the parse tree
	 */
	void exitCatalogProperty(SqlBaseParser.CatalogPropertyContext ctx);
	/**
