        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        bindDataDefinitionTask(binder, executionBinder, LoadPlugin.class, LoadPluginTask.class);
        bindDataDefinitionTask(binder, executionBinder, RefreshCatalog.class, RefreshCatalogTask.class);
