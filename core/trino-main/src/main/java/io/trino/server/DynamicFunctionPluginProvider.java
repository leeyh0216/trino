...
public class DynamicFunctionPluginProvider
        implements PluginManager.PluginsProvider
{
    private final String pluginName;
    private final String pluginDir;

    public DynamicFunctionPluginProvider(String pluginName, String pluginDir)
    {
    ...
    private static List<URL> buildClassPath(File path)
    {
        return listFiles(path).stream()
                .map(DynamicFunctionPluginProvider::fileToUrl)
